...
def profile_init(obj_size=100, ntrials=1000):
...
def profile_1d_numpy(obj_size=100, ntrials=1000):
...
def profile_1d_vector(obj_size=100, ntrials=1000):
    init = f"p = Pingo({obj_size})"
    dur = timeit.timeit(
...
def profile_2d_numpy(obj_size=100, ntrials=1000):
    init = f"p = Pingo({obj_size})"
...
def profile_3d_numpy_copy(obj_size=150, ntrials=1000):
    init = f"p = Pingo({obj_size})"
